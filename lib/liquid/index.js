...
var Liquid, MONTHS, MONTH_ABBRS, Q, WEEKDAYS, WEEKDAY_ABBRS, highlight, md,
...
Liquid.Template.registerTag("highlight", (function() {
...
Liquid.Template.registerTag("extends", (function() {
  var ExtendsTag;
  ...
  date: function(input, format) {
    ...
    return format.replace(/%([a-zA-Z])/g, function(m, f) {
      ...
      switch (f) {
        ...
        case 'b':
          return MONTN_ABBRS[input.getMonth()];
        case 'B':
...
Liquid.Template.extParse = function(src, importer) {
  var baseTemplate, deferred;
  baseTemplate = new Liquid.Template;
  baseTemplate.importer = importer;
  deferred = Q.defer();
  return Q.fcall(function() {
    return baseTemplate.parse(src);
  }).then(function() {
    var depth, stack, walker,
      _this = this;
    ...
    walker = function(tmpl, cb) {
      ...
      return tmpl.importer(tmpl["extends"], function(err, data) {
        if (err) {
          return cb(err);
        }
        if (depth > 100) {
